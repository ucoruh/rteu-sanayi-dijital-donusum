...
<iframe src="../workshop/slides-full.html" width="100%" height="600px" style="border: 2px solid #1976d2; border-radius: 8px; margin-bottom: 1em;" allowfullscreen></iframe>

[:fontawesome-solid-presentation-screen: **Sunumu Tam Ekranda Aç**](../workshop/slides-full.html){ .md-button .md-button--primary target="_blank" }
